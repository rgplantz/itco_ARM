...
### Page 7
1. There are several <i>Linux commands</i> that show you the details of the components in your computer. For example, `lscpu` will show you the details of your CPU:
```
    $ lscpu
