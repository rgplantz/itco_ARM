...
3.  Top and bottom fourths are heads.
    ...
    continue:
            ...
            ret                           // Back to caller
    ```
4.  Removing the break statements removes the bl instruction at the end of cases 1, 2, and 3. The program flow goes to the correct case and then executes the remaining cases in the switch.
    ```asm
    $ ./switch_nb 
    i = 1
    i = 2
